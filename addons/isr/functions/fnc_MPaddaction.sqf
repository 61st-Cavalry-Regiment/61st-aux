...
["Turret Enhanced","add_blk_marker", "Mark Target (Blk)",{_this call FUNC(addMarkerBlk)}, "", [DIK_1, [true, false, false]]] call CBA_fnc_addKeybind;
["Turret Enhanced","add_blu_marker", "Mark Target (Blu)",{_this call FUNC(addMarkerBlu)}, "", [DIK_2, [true, false, false]]] call CBA_fnc_addKeybind;
["Turret Enhanced","add_red_marker", "Mark Target (Red)",{_this call FUNC(addMarkerRed)}, "", [DIK_3, [true, false, false]]] call CBA_fnc_addKeybind;

_unit addAction ["Mark Target (Blk)", QUOTE(_this call FUNC(addMarkerBlk)),nil, _pri,false, true, "", QUOTE(([ARR_2(_this, _target)] call FUNC(isViewISR)) && GVAR(Markers))];
_unit addAction ["Mark Target <t color='#0000FF'>(Blu)</t>", QUOTE(_this call FUNC(addMarkerBlu)),nil, _pri - 1,false, true, "", QUOTE(([ARR_2(_this, _target)] call FUNC(isViewISR)) && GVAR(Markers))];
_unit addAction ["Mark Target <t color='#FF0000'>(Red)</t>", QUOTE(_this call FUNC(addMarkerRed)),nil, _pri - 2,false, true, "", QUOTE(([ARR_2(_this, _target)] call FUNC(isViewISR)) && GVAR(Markers))];
