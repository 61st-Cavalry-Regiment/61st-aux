...
for "_i" from 1 to 4 do {_player addItemToBackPack "rhs_mag_an_m8hc";};
for "_i" from 1 to 2 do {_player addItemToBackPack "rhs_mag_m18_yellow";};
for "_i" from 1 to 2 do {_player addItemToBackPack "rhs_mag_m18_green";};
